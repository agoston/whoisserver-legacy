...
/* If NAME_PREFIX is specified substitute the variables and functions
   names.  */
#define yyparse nserverparse
#define yylex   nserverlex
#define yyerror nservererror
#define yylval  nserverlval
#define yychar  nserverchar
#define yydebug nserverdebug
#define yynerrs nservernerrs
...
#endif
#define TKN_IPV6 258
#define TKN_IPV6DC 259
#define TKN_IPV4 260
#define TKN_HOSTNAME 261
