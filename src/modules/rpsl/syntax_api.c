 ...
 * structure without having to format it as a string first - agoston, 2007-11-05 */
/*
...
/* split all attributes marked list or ripe-list in attributes.xml
 * into separate attributes, e.g.:
 *
 * admin-c:     AA1-RIPE,AA2-RIPE,AA3-RIPE
 *
 * to
 *
 * admin-c:     AA1-RIPE
...
/* Watch out: returned rpsl_object_t has an attribute list that can contain "placeholder" elements that are
 * generated by rpsl_empty_attr() above. You have to handle these placeholder objects in your code.
