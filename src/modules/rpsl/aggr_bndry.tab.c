...
static const yysigned_char yyrhs[] =
{
      ...
      -1,    13,     4,    14,    -1,    13,     5,    14,    -1,    14,
      -1,     8,    12,     9,    -1,    15,    -1,     6,    -1,     7,
      -1
};
...
{
  "$end", "error", "$undefined", "OP_OR", "OP_AND", "KEYW_EXCEPT",
  "TKN_ASNO", "TKN_ASNAME", "'('", "')'", "$accept", "aggr_bndry",
  "as_expr", "as_expr_term", "as_expr_factor", "as_expr_operand", 0
};
#endif
...
{
      11,     1,     2,     3,    12,    13,    14,    10,    16,    17,
      15,    11,     9
};

static const unsigned char yycheck[] =
{
       3,     6,     7,     8,     4,     5,     9,     0,    12,    13,
      11,     3,     3
};
