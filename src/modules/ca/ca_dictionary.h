...
typedef enum
{
    ...
    CA_PL_ERR_NOSOURCE,
    CA_PL_ERR_NOCLASS,
    CA_PL_ERR_NOSEARCHCLASS,
    CA_PL_ERR_DUPSEARCHFLAG,
    CA_PL_ERR_NOSEARCHKEY,
    CA_PL_ERR_BADSEARCHKEY,
    CA_PL_ERR_NOENTRIES,
    CA_PW_RESP_HEADER,
    CA_PW_ERR_NOKEY,
    CA_PW_HELP_FILE,
...
dict_t dictionary[] =
{
    ...
    {   "OVERRIDECRYPTEDPW", "CA_OVERRIDECRYPTEDPW", "CA_STRING", CA_OVERRIDECRYPTEDPW, 0},
    {   "OVERRIDEPGP", "CA_OVERRIDEPGP", "CA_STRING", CA_OVERRIDEPGP, 0},
    ...
    {   "SVLOOKUP_PORT", "CA_SVLOOKUP_PORT", "CA_INT", CA_SVLOOKUP_PORT, 1},
    ...
    {   "PL_HELP_FILE", "CA_PL_HELP_FILE", "CA_DIRLIST", CA_PL_HELP_FILE, 1},
    {   "PL_ERR_BADSOURCE", "CA_PL_ERR_BADSOURCE", "CA_STRING", CA_PL_ERR_BADSOURCE, 1},
    {   "PL_ERR_BADCLASS", "CA_PL_ERR_BADCLASS", "CA_STRING", CA_PL_ERR_BADCLASS, 1},
    {   "PL_ERR_NOSOURCE", "CA_PL_ERR_NOSOURCE", "CA_STRING", CA_PL_ERR_NOSOURCE, 1},
    {   "PL_ERR_NOCLASS", "CA_PL_ERR_NOCLASS", "CA_STRING", CA_PL_ERR_NOCLASS, 1},
    {   "PL_ERR_NOSEARCHCLASS", "CA_PL_ERR_NOSEARCHCLASS", "CA_STRING", CA_PL_ERR_NOSEARCHCLASS, 1},
    {   "PL_ERR_DUPSEARCHFLAG", "CA_PL_ERR_DUPSEARCHFLAG", "CA_STRING", CA_PL_ERR_DUPSEARCHFLAG, 1},
    {   "PL_ERR_NOSEARCHKEY", "CA_PL_ERR_NOSEARCHKEY", "CA_STRING", CA_PL_ERR_NOSEARCHKEY, 1},
    {   "PL_ERR_BADSEARCHKEY", "CA_PL_ERR_BADSEARCHKEY", "CA_STRING", CA_PL_ERR_BADSEARCHKEY, 1},
    {   "PL_ERR_NOENTRIES", "CA_PL_ERR_NOENTRIES", "CA_STRING", CA_PL_ERR_NOENTRIES, 1},
    ...
    {   "QC_USELESSDFLAG", "CA_QC_USELESSDFLAG", "CA_STRING", CA_QC_USELESSDFLAG, 1},
    ...
    {   "QI_BADRANGE", "CA_QI_BADRANGE", "CA_STRING", CA_QI_BADRANGE, 1},
    {   "QC_TRAILINGDOTINDOMAIN", "CA_QC_TRAILINGDOTINDOMAIN", "CA_STRING", CA_QC_TRAILINGDOTINDOMAIN, 1},
    ...
    {   "QI_INTERNAL_ERROR", "CA_QI_INTERNAL_ERROR", "CA_STRING", CA_QI_INTERNAL_ERROR, 1},
    ...
    {   "OPEREMAIL", "CA_OPEREMAIL", "CA_STRING", CA_OPEREMAIL, 0},
    {   "NRTM_HISTORY_ACCESS_LIMIT", "CA_NRTM_HISTORY_ACCESS_LIMIT", "CA_INT", CA_NRTM_HISTORY_ACCESS_LIMIT, 0},
