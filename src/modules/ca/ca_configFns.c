...
void
stringPack(char *dest, const char *source)
/****************************************************************
...
void
ca_populateDictionary(dict_t woordenboek[], int size)
/*******************************************************************
...
void
opSplitsen(FILE * filePtr, gchar ** tokenArray)
/*******************************************************************
...
void
ca_readConfig(const char *configFile, values_t confVars[], int size)
/*******************************************************************
 *                                            *
		...
		if ((strncmp(name, comment, 1) != 0) && (strncmp(name, blankLine, 1) != 0)) {
			...
			case 17:
                ...
                if ( num_sources < CA_MAXSOURCES )
                {
				  ...
				  memcpy( ((ca_updDbSource_t **)confVars[location].valPtr)[num_sources++], newUpdSrc, sizeof(ca_updDbSource_t));
                }
                else
                {
...
void
ca_getDictionary(dict_t woordenboek[], int size)
{
	int k;
...
int *
ca_change_int_value(char value[])
{
	void *tempPtr;
...
void
ca_getDatabase(ca_database_t db)
{
	printf("\n%s\t%d\t%s\t%s\t%s\n", db.host, db.port, db.user, db.password, db.dbName);
}

void
ca_getSource(ca_database_list_t src)
{
...
void
ca_getAllSources(GSList * sources)
{
...
void
ca_getAsource(char *sourceName, GSList * sources)
/*******************************************************************
...
ca_dbSource_t *
ca_getSourceDetails(char *sourceName, GSList * sources)
/*******************************************************************
 * ca_getSourceDetails                              *
...
ca_SrcHdl_t *
ca_get_SourceHandleByPosition(int position)
/*******************************************************************
...
ca_SrcHdl_t *
ca_get_SourceHandleByName(char *srcName)
/*******************************************************************
...
char *
ca_srchandle2Strelement(ca_SrcHdl_t * ah, int srcAttrib)
/*******************************************************************
...
int
ca_srchandle2Intelement(ca_SrcHdl_t * ah, int srcAttrib)
/*******************************************************************
...
char *
ca_get_adminStrElement(int symbol, int adminAttrib)
/*******************************************************************
  * ca_adminStrElement
...
int
ca_get_adminIntElement(int symbol, int adminAttrib)
/*
...
int
ca_writeNewValue(int dictSymbol, char *newValue)
{
...
int
ca_getStorageLocation(char *confVar, dict_t woordenboek[], int size)
/*************************************************************
...
void
ca_getConfig(values_t confVars[], int size)
/*************************************************************
...
int
ca_getType(char *confVar, dict_t woordenboek[], int size)
/****************************************************************
...
ca_updDbSource_t **
ca_get_UpdSourceHandle(int symbol)
/*******************************************************************
...
char *
ca_UpdSrcHandle2StrElement(ca_updDbSource_t * uh, int srcAttrib)
/*******************************************************************
...
int
ca_UpdSrcHandle2IntElement(ca_updDbSource_t * uh, int srcAttrib)
/*******************************************************************
