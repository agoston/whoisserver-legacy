...
ADAPT(PL_HELP_FILE, DIRLIST, 1)
ADAPT(PL_ERR_BADSOURCE, STRING, 1)
ADAPT(PL_ERR_BADCLASS, STRING, 1)
ADAPT(PL_ERR_NOSOURCE, STRING, 1)
ADAPT(PL_ERR_NOCLASS, STRING, 1)
ADAPT(PL_ERR_NOSEARCHCLASS, STRING, 1)
ADAPT(PL_ERR_DUPSEARCHFLAG, STRING, 1)
ADAPT(PL_ERR_NOSEARCHKEY, STRING, 1)
ADAPT(PL_ERR_BADSEARCHKEY, STRING, 1)
ADAPT(PL_ERR_NOTREE, STRING, 1)
ADAPT(PL_ERR_NOENTRIES, STRING, 1)
