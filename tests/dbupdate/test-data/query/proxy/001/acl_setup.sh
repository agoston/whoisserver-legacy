...
INSERT INTO acl6 VALUES (0,0,0,0,128,2000,-1,10,0,0,4,6,'Stupid test');
EOM
...
issue_command show access | awk '/^::\/[1-9]/ {print $4}' >$DATADIR/query/proxy/001/denials_count
[ -s $DATADIR/query/proxy/001/denials_count ] || echo 0 >$DATADIR/query/proxy/001/denials_count