...
INSERT INTO acl6 VALUES (0,0,0,0,128,2000,-1,10,1,0,4,6,'Stupid test');
EOM
...
issue_command show access | awk '/^::\/[1-9]/ {print $4}' >$DATADIR/query/acl/003/denials_count
[ -s $DATADIR/query/acl/003/denials_count ] || echo 0 >$DATADIR/query/acl/003/denials_count
